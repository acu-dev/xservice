...
public class ContextPerRequestFilter implements Filter {
    ...
    public static final String XYTHOS_SESSION_ID = "edu.acu.wip.mobile.files.XYTHOS_SESSION_ID";
    public static final String XYTHOS_SECURITY_TOKEN = "edu.acu.wip.mobile.files.XYTHOS_SECURITY_TOKEN";
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
        ...
        if (sessionId == null) {
            try {
                ...
                logger.error("Error finding xythos session for " + username, e);
            }
